...
int TextEditor::GetCharacterIndex(const Coordinates& aCoordinates) const
{
  ...
  int c = 0;
  int i = 0;
  for (; (size_t)i < line.size() && c < aCoordinates.mColumn;)
  {
    if (line[i].mChar == '\t')
...
void TextEditor::Render()
{
  ...
  if (!mLines.empty())
  {
    ...
    while (lineNo <= lineMax)
    {
      ...
      for (int i = 0; (size_t)i < line.size();)
      {
        auto& glyph = line[i];
...
void TextEditor::ColorizeInternal()
{
  ...
  if (mCheckComments)
  {
    ...
    auto currentLine = 0;
    auto currentIndex = 0;
    while ((size_t)currentLine < endLine || (size_t)currentIndex < (size_t)endIndex)
    {
      ...
      if (!line.empty())
      {
        ...
        bool inComment = ((size_t)commentStartLine < (size_t)currentLine ||
          ((size_t)commentStartLine == (size_t)currentLine && (size_t)commentStartIndex <= (size_t)currentIndex));
        ...
        else
        {
          ...
          else
          {
            ...
            inComment = inComment = ((size_t)commentStartLine < (size_t)currentLine ||
              ((size_t)commentStartLine == (size_t)currentLine && (size_t)commentStartIndex <= (size_t)currentIndex));
...
float TextEditor::TextDistanceToLineStart(const Coordinates& aFrom) const
{
  ...
  for (size_t it = 0u; (size_t)it < line.size() && (size_t)it < (size_t)colIndex; )
  {
    if (line[it].mChar == '\t')
    {
    ...
    else
    {
      ...
      char tempCString[7];
      int i = 0;
      for (; i < 6 && d-- > 0 && (size_t)it < (size_t)(int)line.size(); i++, it++)
